                  ...
                  children: [
                    ...
                    Container(
                        ...
                        child: InfoCard(
                            ...
                            percentage: reportModel.orderQuantityPercent
                                .toString())),
                    ...
                    Container(
                        ...
                        child: InfoCard(
                          title: 'T',
                          value: reportModel
                              .formatCurrencyDouble(reportModel.netRevenue),
                          percentage: reportModel.netRevenuePercent
                              .toString(),
                        )),
                    const SizedBox(height: 16),
                    Container(
                        ...
                        child: InfoCard(
                            title: 'Thực nhận',
                            value: reportModel.formatCurrencyDouble(
                                reportModel.receivedMoney),
                            percentage: reportModel.receivedMoneyPercent
                                .toString())),
                    const SizedBox(height: 16),
                      ...
                      children: [
                        Expanded(
                            child: InfoCard(
                                title: 'Số đơn hàng',
                                value: reportModel
                                    .filteredOrders1.length
                                    .toString(),
                                percentage: reportModel
                                    .orderQuantityPercent
                                    .toString())),
