...
class _ProductDetailViewState extends State<ProductDetailView> {
  ...
  final List<String> attributeOptions = ['Nam', 'Nữ', 'Unisex'];
  final List<String> warehouseOptions = ['Kho 1', 'Kho 2', 'Kho 3'];
          ...
          child: Column(
            children: [
              ...
              InventoryManagement(
                ...
                onWarehouseChanged: (value) => setState(() => selectedWarehouse = value),
              ),
              const SizedBox(height: 20),
              Container(
