...
class _ReportDashboardState extends State<BusinessAnalysis> {
  ...
  Widget _buildLineChart() {
    return Container(
      ...
      height: 400,
      width: double.infinity, // Đặt chiều rộng toàn màn hình nếu maxWidth không định nghĩa
      decoration: BoxDecoration(
        color: Colors.white,
      ...
      child: Column(
        ...
        children: [
          Expanded(
            child: Line_Chart(
              spots1: ChartDataProvider.generateCurrentDayData(), // Dữ liệu line 1
          ...
          Align(
            ...
            child: Row(
              mainAxisSize: MainAxisSize.min, // Thu nhỏ kích thước theo nội dung
              children: [
                _buildLegendItem(Colors.blue, '29/12/2024'), // Ghi chú cho line 1
                const SizedBox(width: 20),
                _buildLegendItem(Colors.green.withOpacity(0.5), '28/12/2024'), // Ghi chú cho line 2
              ],
            ),
          ),
        ],
